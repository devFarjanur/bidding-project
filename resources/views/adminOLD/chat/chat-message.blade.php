														...
														<div class="sherah-chatbox__top">
															<div class="sherah-chatbox__inner sherah-border-btm pd-btm-20 mg-btm-10">
																<div class="sherah-chatbox__author">
																	<div class="sherah-chatbox__author-img sherah-chatbox__author-img-sticky">
																		<img src="{{ asset('backend/assets/img/chat-author10.png') }}" alt="#">
															...
															<form class="sherah-chatbox-form" action="#">
																...
																<button class="search-btn" type="submit">
																	<svg class="sherah-color1__fill" width="16" height="16" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
														...
														<ul class="sherah-chatbox__list">
															...
															<li>
																<div class="sherah-chatbox__inner">
																	<div class="sherah-chatbox__author">
																		<div class="sherah-chatbox__author-img">
																			<img src="{{ asset('backend/assets/img/chat-author6.png') }}" alt="#">
																			<span class="sherah-chatbox__author-online"></span>
																		</div>
																		<div class="sherah-chatbox__author-content">
																			<h4 class="sherah-chatbox__author-title">Thlatics Han</h4>
															...
															<li>
																<div class="sherah-chatbox__inner">
																	<div class="sherah-chatbox__author">
																		<div class="sherah-chatbox__author-img">
																			<img src="{{ asset('backend/assets/img/chat-author7.png') }}" alt="#">
																			<span class="sherah-chatbox__author-online author-not-online"></span>
																		</div>
																		<div class="sherah-chatbox__author-content">
																			<h4 class="sherah-chatbox__author-title">Atlamtan Jhon</h4>
																			<p class="sherah-chatbox__author-desc">Sent to your all files a ....</p>
																		</div>
																	</div>
																</div>
															</li>
															...
															<li>
																<div class="sherah-chatbox__inner">
																	<div class="sherah-chatbox__author">
																		<div class="sherah-chatbox__author-img">
																			<img src="{{ asset('backend/assets/img/chat-author8.png') }}" alt="#">
																			<span class="sherah-chatbox__author-online author-is-busy"></span>
																		</div>
																		<div class="sherah-chatbox__author-content">
																			<h4 class="sherah-chatbox__author-title">Nitanman</h4>
																			<p class="sherah-chatbox__author-desc">Hi! How are you?</p>
																		</div>
																	</div>
																</div>
															</li>
															...
															<li>
																<div class="sherah-chatbox__inner">
																	<div class="sherah-chatbox__author">
																		<div class="sherah-chatbox__author-img">
																			<img src="{{ asset('backend/assets/img/chat-author9.png') }}" alt="#">
																			<span class="sherah-chatbox__author-online"></span>
																		</div>
																		<div class="sherah-chatbox__author-content">
																			<h4 class="sherah-chatbox__author-title">Hanmaram</h4>
																			<p class="sherah-chatbox__author-desc">Let's go on the way.</p>
																		</div>
																	</div>
																</div>
															</li>
												...
												<div class="col-lg-8 col-md-8 col-12  sherah-chatbox__two mg-top-30">
													<div class="sherah-chatbox__explore sherah-default-bg sherah-border">
														<div class="sherah-chatbox__explore-head sherah-border-btm">
															<div class="sherah-chatbox__author">
																<div class="sherah-chatbox__author-img sherah-chatbox__author-img-sticky">
																	<img src="{{ asset('backend/assets/img/chat-top-ms.png') }}" alt="#">
																	<span class="sherah-chatbox__author-online"></span>
																</div>
																<div class="sherah-chatbox__heading">
																	<h4 class="sherah-chatbox__heading--title">Hastamjaian</h4>
																	<p class="sherah-chatbox__heading--text sherah-pcolor">Available</p>
																</div>
															</div>
																		...
																		<div class="sherah-chatbox__chat">
																			...
																			<div class="sherah-chatbox__main-content">
																				<div class="sherah-chatbox__incoming-chat">
																					<p class="sherah-chatbox__incoming-text">Hey, Marshall! How are you? Can you please and change the color themei of the website to pink. I Can you as please change the color a theme of the website to pink and purple?</p>
																				</div>
																			</div>
																		</div>
																	</li>
																...
																<ul class="sherah-chatbox__incoming-list">
																	...
																	<li>
																		<div class="sherah-chatbox__chat">
																			<div class="sherah-chatbox__main-content">
																				<div class="sherah-chatbox__incoming-chat">
																					<p class="sherah-chatbox__incoming-text">Send me the files please.</p>
																				</div>
																			</div>
																			<div class="sherah-chatbox__author-img sherah-chatbox__author-img-sticky">
																				<img src="{{ asset('backend/assets/img/chat-top-ms.png') }}" alt="#">
																	...
																	<li>
																		<div class="sherah-chatbox__chat">
																			<div class="sherah-chatbox__main-content">
																				<div class="sherah-chatbox__incoming-chat">
																					<p class="sherah-chatbox__incoming-text">Can you please change the color theme the website.</p>
																				</div>
																			</div>
																			<div class="sherah-chatbox__author-img sherah-chatbox__author-img-sticky">
																				<img src="{{ asset('backend/assets/img/chat-top-ms.png') }}" alt="#">
																...
																<ul class="sherah-chatbox__incoming-list">
																	...
																	<li>
																		<div class="sherah-chatbox__chat">
																			...
																			<div class="sherah-chatbox__main-content">
																				<div class="sherah-chatbox__incoming-chat">
																					<p class="sherah-chatbox__incoming-text">In computer programming, a comment is a progriammer as readable explanation or annotatons source code of a computer program  They are added a our the purpose of making the source as code easier for humans to understand, and are generally ignored.There are many variations of passages of Lorem asIpsum available, but the majority have suffered alteration in some form.</p>
																				</div>
																			</div>
																		</div>
																	</li>
																	...
																	<li>
																		<div class="sherah-chatbox__chat">
																			...
																			<div class="sherah-chatbox__main-content">
																				<div class="sherah-chatbox__incoming-chat">
																					<p class="sherah-chatbox__incoming-text">They are added with the purpose of making the source.</p>
																				</div>
																			</div>
																		</div>
																	</li>
																...
																<ul class="sherah-chatbox__incoming-list">
																	...
																	<li>
																		<div class="sherah-chatbox__chat">
																			<div class="sherah-chatbox__main-content">
																				<div class="sherah-chatbox__incoming-chat">
																					<p class="sherah-chatbox__incoming-text">Mention of something that deserves</p>
																					<ul class="sherah-chatbox__imoji">
																						<li><img src="{{ asset('backend/assets/img/imoji.png') }}" alt="#"></li>
																						<li><img src="{{ asset('backend/assets/img/imoji.png') }}" alt="#"></li>
																					</ul>
																				</div>
																			</div>
															...
															<div class="sherah-chatbox__new-message">
																<div class="sherah-chatbox__form">
																	<form class="sherah-chatbox__form-inner" action="#">
																		...
																		<input name="s" value="" type="text" placeholder="Type your message....">
																		<div class="sherah-chatbox__button">
																			<div class="sherah-chatbox__button-inline">
																				<div class="sherah-chatbox__btn sherah-chatbox__record">
																					<a href="#">
																						<svg class="sherah-offset__fill" xmlns="http://www.w3.org/2000/svg" width="14.586" height="24.076" viewBox="0 0 14.586 24.076">
																							<g id="mic" transform="translate(-95.922)">
																							  <g id="Group_22" data-name="Group 22" transform="translate(99.129)">
																								<g id="Group_21" data-name="Group 21">
																								  <path id="Path_215" data-name="Path 215" d="M170.393,0a4.091,4.091,0,0,0-4.086,4.086v8.031a4.087,4.087,0,0,0,8.173.028V4.086A4.091,4.091,0,0,0,170.393,0Zm2.384,12.146a2.384,2.384,0,0,1-4.767-.028V4.086a2.384,2.384,0,1,1,4.767,0Z" transform="translate(-166.307)" />
																								</g>
																							  </g>
																							  <g id="Group_24" data-name="Group 24" transform="translate(102.364 19.394)">
																								<g id="Group_23" data-name="Group 23">
																								  <rect id="Rectangle_38" data-name="Rectangle 38" width="1.703" height="3.831" />
																								</g>
																							  </g>
																							  <g id="Group_26" data-name="Group 26" transform="translate(100.122 22.373)">
																								<g id="Group_25" data-name="Group 25">
																								  <path id="Path_216" data-name="Path 216" d="M193.442,474.628h-4.484a.851.851,0,1,0,0,1.7h4.484a.851.851,0,0,0,0-1.7Z" transform="translate(-188.107 -474.628)" />
																								</g>
																							  </g>
																							  <g id="Group_28" data-name="Group 28" transform="translate(95.922 11.251)">
																								<g id="Group_27" data-name="Group 27">
																								  <path id="Path_217" data-name="Path 217" d="M109.657,234.822a.851.851,0,0,0-.851.851v.681a5.591,5.591,0,0,1-11.181,0v-.681a.851.851,0,0,0-1.7,0v.681a7.293,7.293,0,1,0,14.586,0v-.681A.851.851,0,0,0,109.657,234.822Z" transform="translate(-95.922 -234.822)" />
																								</g>
																							  </g>
																							</g>
																						</svg>
																				...
																				<div class="sherah-chatbox__btn sherah-chatbox__imoji">
																					<a href="#">
																						<svg class="sherah-offset__fill" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25">
																							<path id="smile" d="M12.5,25A12.5,12.5,0,0,1,3.661,3.661,12.5,12.5,0,0,1,21.339,21.339,12.419,12.419,0,0,1,12.5,25Zm0-23.047A10.547,10.547,0,1,0,23.047,12.5,10.559,10.559,0,0,0,12.5,1.953Zm4.577,12.7a.976.976,0,0,0-1.348.3,4.3,4.3,0,0,1-3.278,1.891,4.3,4.3,0,0,1-3.278-1.891.977.977,0,0,0-1.648,1.049,6.279,6.279,0,0,0,4.925,2.8,6.278,6.278,0,0,0,4.925-2.8.977.977,0,0,0-.3-1.348ZM8.2,8.057A1.221,1.221,0,1,1,6.982,9.277,1.221,1.221,0,0,1,8.2,8.057Zm7.324,1.221a1.221,1.221,0,1,0,1.221-1.221A1.221,1.221,0,0,0,15.527,9.277Z" />
																						</svg>	  
																					</a>
																				</div>
																				<div class="sherah-chatbox__btn sherah-chatbox__image">
																					<a href="#">
																						<svg class="sherah-offset__fill" xmlns="http://www.w3.org/2000/svg" width="26.725" height="24.498" viewBox="0 0 26.725 24.498">
																							<g id="image1" transform="translate(0 -0.492)">
																							  <path id="Path_211" data-name="Path 211" d="M19.713,185.735a2.524,2.524,0,0,1-.638-.082l-17.22-4.611a2.528,2.528,0,0,1-1.773-3.068l1.893-7.259a.835.835,0,0,1,1.616.422L1.7,178.4a.85.85,0,0,0,.595,1.032l17.21,4.609a.83.83,0,0,0,1.014-.586l.588-2.372a.835.835,0,0,1,1.621.4l-.59,2.383a2.508,2.508,0,0,1-2.423,1.871Zm0,0" transform="translate(0 -160.744)" />
																							  <path id="Path_212" data-name="Path 212" d="M105.086,18.309H87.825A2.508,2.508,0,0,1,85.32,15.8V3A2.508,2.508,0,0,1,87.825.492h17.26A2.508,2.508,0,0,1,107.591,3V15.8A2.508,2.508,0,0,1,105.086,18.309ZM87.825,2.162A.835.835,0,0,0,86.99,3V15.8a.835.835,0,0,0,.835.835h17.26a.835.835,0,0,0,.835-.835V3a.835.835,0,0,0-.835-.835Zm0,0" transform="translate(-80.866 0)" />
																							  <path id="Path_213" data-name="Path 213" d="M151.547,68.946a2.227,2.227,0,1,1,2.227-2.227A2.229,2.229,0,0,1,151.547,68.946Zm0-2.784a.557.557,0,1,0,.557.557A.557.557,0,0,0,151.547,66.162Zm0,0" transform="translate(-141.526 -60.659)" />
																							  <path id="Path_214" data-name="Path 214" d="M86.589,124.267a.836.836,0,0,1-.59-1.426l5.033-5.033a1.954,1.954,0,0,1,2.762,0l1.346,1.346,4.136-4.964a1.948,1.948,0,0,1,1.488-.7,1.791,1.791,0,0,1,1.493.685l5.543,6.467a.836.836,0,0,1-1.268,1.088l-5.545-6.47a.334.334,0,0,0-.214-.1.28.28,0,0,0-.214.1l-4.721,5.668a.834.834,0,0,1-.6.3.819.819,0,0,1-.628-.244l-1.993-1.993a.241.241,0,0,0-.4,0l-5.033,5.032a.829.829,0,0,1-.59.245Zm0,0" transform="translate(-81.277 -107.094)" />
																							</g>
																						</svg>
																					</a>
																				</div>
																			...
																			<div class="sherah-chatbox__submit">
																				<button class="sherah-chatbox__submit-btn" type="submit">
																					<svg xmlns="http://www.w3.org/2000/svg" width="18.695" height="16.249" viewBox="0 0 18.695 16.249">
																						<g id="send" transform="translate(-0.001 -33.492)">
																						  <path id="Path_218" data-name="Path 218" d="M18.683,34.156a.548.548,0,0,0-.731-.627L.353,40.247a.548.548,0,0,0,0,1.023L5.3,43.179v6.014a.548.548,0,0,0,1.037.246l2.045-4.058,4.99,3.7a.548.548,0,0,0,.85-.28C18.876,33.53,18.675,34.194,18.683,34.156ZM14.339,36.08,5.765,42.186,2.077,40.761ZM6.391,43.085l7.473-5.322c-6.43,6.784-6.095,6.427-6.123,6.464-.042.056.072-.162-1.35,2.661ZM13.4,47.742,9,44.483,16.945,36.1Z" transform="translate(0 0)" fill="#fff"/>
																						</g>
																					  </svg>
																					  Send
																				</button>
