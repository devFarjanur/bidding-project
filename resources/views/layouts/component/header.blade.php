            ...
            <div class="row align-items-center">
                <div class="col-xxl-4 col-xl-3">
                    <div class="topbar-info d-none d-xl-block">
                        <p class="text-white fs-sm fw-medium mb-0">Welcome to Add Family</p>
                    </div>
                </div>
                <div class="col-xxl-8 col-xl-9">
                    <ul
                        ...
                        <li class="nav-item">
                            <a href="mailto:medicine@gmail.com">
                                <span class="me-1">
                        ...
                        <li class="nav-item">
                            ...
                            Sector-10, Road-12B, Bangladesh - 2542
                        </li>
                        <li class="nav-item">
                            ...
                            <ul class="d-flex align-itmes-center justify-content-end">
                                ...
                                @auth
                                    ...
                                    {{ route('customer.myaccount') }}
                                     ">My
                                            Account<span class="ms-1 fs-xs float-end"></span></a>
